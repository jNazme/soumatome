        ...
        try{
            ...
            if (cs != null) {
                for (int i = 1;i< cs.length;i++) {
                    ...
                    String k = cs[i].getName().substring(6);
                    if (k.equals(String.valueOf(udt.getUserID())) && !(itemName.equals(""))) {
                    UserDataDAO .getInstance().purchase(udt.getUserID(), cs[i].getValue(), request.getParameter("type"));
                    cs[i].setValue("");
                        cs[i].setMaxAge(0);
